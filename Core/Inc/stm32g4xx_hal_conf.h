...
/* Hand-enabled for the ported PWM/HRTIM module (hrtim.c) -- HRTIM1 was
   never added in the .ioc's own pinout/peripheral selection, so this
   line (and the driver files it requires, copied into Drivers/ rather
   than CubeMX-generated) will NOT survive a "Generate Code" from the
   .ioc; re-apply it if that happens. Same category of regen hazard as
   main.c's hand-set 9600 baud rate -- see AGENTS.md. */
